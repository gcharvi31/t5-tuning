...
#SBATCH --job-name=gsm_model_5              # Assign an short name to your job
...
python /home/cg4177/t5-tuning/t5_gsm8k.py --identifier model_5 --model_name t5-base --batch_size 4 --epochs 20 --fp_precision 32 --devices 2 --num_workers 2 --strategy ddp_sharded